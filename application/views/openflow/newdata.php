...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">เบิกสินค้าใหม่</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url('openflow/postdata'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">จำนวนเบิก</label> <?php echo $this->session->flashdata('error_open_qty'); ?> <?php echo $this->session->flashdata('error_onqty'); ?>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">วันที่เบิกสินค้า</label> <?php echo $this->session->flashdata('error_open_date'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <span class="input-group-btn">
                                <a class="btn btn-info btn-flat popupwindow" rel="windowCenter" role="button" href="<?php echo base_url(); ?>openflow/userup"><i class="fa fa-search"></i> ค้นหาผู้เบิกสินค้า</a>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
